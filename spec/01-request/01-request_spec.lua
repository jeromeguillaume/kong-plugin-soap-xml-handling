...
--			end)
			...
			it("2+3|WSDL Validation for Add with ForceSchemaLocation - Invalid XSD included in config that overwrites valid XSD (without schemaLocation) in WSDL Ko", function()
				request_common._2_3_WSDL_Validation_Add_with_ForceSchemaLocation_for_Imports_without_schemaLocation_and_Invalid_XSD_in_config_with_verbose_ko (assert, client)
			end)

			it("2+3|WSDL Validation for Subtract with ForceSchemaLocation - Invalid XSD included in config that overwrites valid XSD (with schemaLocation) in WSDL - Ko", function()
				request_common._2_3_WSDL_Validation_Subtract_with_ForceSchemaLocation_for_Imports_without_schemaLocation_and_Invalid_XSD_in_config_with_verbose_ko (assert, client)
			end)

			it("2+3|WSDL Validation for Add with ForceSchemaLocation - Imports without schemaLocation - Some XSDs are not included in WSDL - Ko", function()
				request_common._2_3_WSDL_Validation_Add_with_ForceSchemaLocation_and_Some_XSDs_are_not_included_in_WSDL_with_verbose_ko (assert, client)
			end)
