...
kubectl create configmap scen1witherror --from-file ./scen1witherror.js -o yaml --dry-run=client | kubectl apply -f - 
...
kubectl create configmap scen3witherror --from-file ./scen3witherror.js -o yaml --dry-run=client | kubectl apply -f - 
