...
#KONG_IMAGE=jeromeguillaume/kong-soap-xml:3.10.0.1-1.4.0-12.5-beta.2 pongo run --lpath=$PWD/spec/common

# Run pongo tests by using the code of plugins included in the Docker image
KONG_IMAGE=jeromeguillaume/kong-soap-xml:3.10.0.1-1.4.0-12.5-beta.2 pongo run
