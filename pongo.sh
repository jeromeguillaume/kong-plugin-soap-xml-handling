...
#------------------------------------------------------------------------------
# pongo clean
# KONG_IMAGE=jeromeguillaume/kong-soap-xml:3.14.0.5-1.4.7-12.9 pongo build --force
...
#KONG_IMAGE=jeromeguillaume/kong-soap-xml:3.14.0.5-1.4.7-12.9 pongo run --lpath=$PWD/spec/common --helper=./spec/busted-ci-helper.lua

# Run pongo tests by using the code of plugins included in the Docker image
KONG_IMAGE=jeromeguillaume/kong-soap-xml:3.14.0.5-1.4.7-12.9 pongo run --helper=./spec/busted-ci-helper.lua
