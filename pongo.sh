...
#------------------------------------------------------------------------------
# pongo clean
# KONG_IMAGE=jeromeguillaume/kong-soap-xml:3.13.0.1-1.4.5-12.9 pongo build --force
...
#KONG_IMAGE=jeromeguillaume/kong-soap-xml:3.13.0.1-1.4.5-12.9 pongo run --lpath=$PWD/spec/common --helper=./spec/busted-ci-helper.lua

# Run pongo tests by using the code of plugins included in the Docker image
KONG_IMAGE=jeromeguillaume/kong-soap-xml:3.13.0.1-1.4.5-12.9 pongo run --helper=./spec/busted-ci-helper.lua
