...
### Example (E): Request and Response | `SOAP 1.2` `XSD VALIDATION`: use a `SOAP 1.2` `XSD` defintion and the `caclulator` API `XSD` definition
...
...
```
### Example (F): Request | `WSDL VALIDATION`: validate the `SOAPAction` Htt header
