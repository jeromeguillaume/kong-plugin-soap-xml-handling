...
- v1.4.0
  - Added the file support for WSDL/XSD/XSLT definition. For instance the raw WSDL content (ewample: `<wsdl:definitions...</wsdl:definitions>` can be replaced by `/usr/local/xml-files/mycontent.wsdl`)
