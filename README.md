...
- v1.3.2
  - Improved the performance by compiling and paring WSDL, XSD and XSLT definitions only once per plugin (managed by a new `kong.xmlSoapPtrCache.plugins[plugin_id]` table)
