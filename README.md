...
|:------------------------------|:----------------|:-----------------------------------------------------------|
|config.customFaultCode|N/A|HTTP status code returned in case of SOAP Fault or error|
|config.customFaultXslt|N/A|`XSLT` definition to customize the SOAP Fault|
